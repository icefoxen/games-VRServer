...
namespace VRLib
{
	public class Collider
	{
		...
		public virtual bool CollideWithSphere(SphereCollider c)
		{
			return false;
		}
	...
	public class SphereCollider : Collider
	{
		...
		public SphereCollider(Vector3d loc, double rad)
		{
			Location = loc;
			Radius = rad;
		}
		...
		public override bool Colliding(Collider c)
		{
			...
			return c.CollideWithSphere(this);
		}
		public override bool CollideWithSphere(SphereCollider c)
		{
			Vector3d separation = Vector3d.Subtract(Location, c.Location);
			double rad = Radius + c.Radius;
			return separation.LengthSquared <= (rad * rad);
		}
		public override bool CollideWithRay(RayCollider c)
		{
			//return Util.CollideRayWithCircle(c.Location, c.Ray, Location, Radius);
			return false;
		}
	}
	...
	{
		public Vector3d Ray;
		public RayCollider(Vector3d loc, Vector3d ray)
		{
			Ray = ray;
			Location = loc;
		}
		...
		public override bool CollideWithSphere(SphereCollider c)
		{
			//return Util.CollideRayWithSphere(Location, Ray, c.Location, c.Radius);
			return false;
		}
